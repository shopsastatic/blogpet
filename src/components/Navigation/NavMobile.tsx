...
const NavMobile: React.FC<NavMobileProps> = ({
	...
	return (
		<div className="h-screen w-full transform divide-y-2 divide-neutral-100 overflow-y-auto bg-white shadow-lg ring-1 transition dark:divide-neutral-800 dark:bg-black dark:ring-neutral-700">
			<div className="px-5 py-7 bg-[#1b1b1b] sticky top-0 z-50">
				<span className="absolute end-2 top-1.5 p-1">
					<ButtonClose className='text-white' onClick={onClickClose} />
				</span>

			</div>
			<ul className="flex flex-col space-y-1 px-2 py-6 rtl:space-x-reverse">
				<p className='text-lg font-bold mb-5'>Explore categories</p>
